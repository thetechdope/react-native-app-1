    ...
    <CustomHeader>
      <ScrollView>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: '8%', marginLeft: '8%' }}>
          <Image style={{ height: 40, width: 40, borderRadius: 20, backgroundColor: '#7E50EE1A', marginRight: '4%' }} source={Logopath.location} />
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginLeft: '8%' }}>
          <Image style={{ height: 40, width: 40, borderRadius: 20, backgroundColor: '#7E50EE1A', marginRight: '4%' }} source={Logopath.contact} />
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginLeft: '8%', marginBottom: '6%' }}>
          <Image style={{ height: 40, width: 40, borderRadius: 20, backgroundColor: '#7E50EE1A', marginRight: '4%' }} source={Logopath.globe} />
